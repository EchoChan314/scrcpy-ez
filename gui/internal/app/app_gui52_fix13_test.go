...
func TestGui52Fix13CommitClearsOrphanBeforeNames(t *testing.T) {
	...
	a.profiles.mu.Lock()
	a.profiles.data.Devices["192.0.2.162:36475"] = &DeviceEntry{
		Addrs:    []AddrEntry{{Addr: "192.0.2.162:36475", State: AddrStateActive, Mode: ModeTls}},
	...
	a.profiles.data.Devices["Xiaomi Pad 8 Pro"] = &DeviceEntry{
		...
		Addrs: []AddrEntry{
			...
			{Addr: "192.0.2.162:42747", State: AddrStateActive, Mode: ModeTls},
		},
		Profiles: DefaultProfile(),
	}
	a.profiles.data.DeviceOrder = []string{"192.0.2.162:36475", "Xiaomi Pad 8 Pro"}
	...
	a.commitDisplay([]adb.Device{
		{Serial: "192.0.2.162:36475", State: "device", ConnType: "wifi"},
	...
	if _, ok := a.profiles.Entries()["192.0.2.162:36475"]; ok {
