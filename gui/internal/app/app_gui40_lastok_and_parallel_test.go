...
func TestGui40RecentOkAddrStaleTlsSkip(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			addrs: []AddrEntry{
				{Addr: "192.0.2.197:35263", State: AddrStateStale, LastOk: 1787745659, Mode: ModeTls, Stale: true},
				{Addr: "192.0.2.197:5555", State: AddrStateActive, LastOk: 1787771715, Mode: ModeTcpip},
			},
		...
		},
		{
			...
			addrs: []AddrEntry{
				{Addr: "192.0.2.162:5555", State: AddrStateActive, LastOk: 1787771700, Mode: ModeTcpip},
				{Addr: "192.0.2.162:39419", State: AddrStateActive, LastOk: 1787771881, Mode: ModeTls},
			},
			want: "192.0.2.162:39419",
		},
		{
			name: "tls active 但 lastOk 更旧也优先（lastOk 不入判据）",
			addrs: []AddrEntry{
				{Addr: "192.0.2.197:5555", State: AddrStateActive, LastOk: 200, Mode: ModeTcpip},
				{Addr: "192.0.2.197:42449", State: AddrStateActive, LastOk: 100, Mode: ModeTls},
			},
		...
		},
		{
			...
			addrs: []AddrEntry{
				{Addr: "192.0.2.197:42449", State: AddrStateStale, LastOk: 300, Mode: ModeTls, Stale: true},
		...
		},
		{
			...
			addrs: []AddrEntry{
				{Addr: "192.0.2.197:42449", State: AddrStateActive, LastOk: 0, Mode: ModeTls},
...
func TestGui40RecentOkAddrTcpipStaleStillShown(t *testing.T) {
	e := DeviceEntry{Addrs: []AddrEntry{
		...
		{Addr: "192.0.2.197:42449", State: AddrStateStale, LastOk: 0, Mode: ModeTls, Stale: true},
	}}
