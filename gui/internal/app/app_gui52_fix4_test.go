...
func TestGui52Fix4ProbeActiveAllFailToStale(t *testing.T) {
	...
	if ae := gui24FindAddr(e, "192.0.2.162:5555"); ae == nil || ae.State != AddrStateStale {
...
func TestGui52Fix4ProbeActiveMixed(t *testing.T) {
	...
	if ae := gui24FindAddr(e, "192.0.2.162:5555"); ae == nil || ae.State != AddrStateActive {
...
func TestGui52Fix4ProbeSkipsStale(t *testing.T) {
	...
	gui15Seed(a.profiles, "Xiaomi Pad 8 Pro", &DeviceEntry{
		...
		Serials:    []string{"TEST0002"},
		Addrs: []AddrEntry{
			{Addr: "192.0.2.162:44125", State: AddrStateStale, Mode: ModeTls},
			{Addr: "192.0.2.162:5555", State: AddrStateActive, Mode: ModeTcpip},
		},
		Profiles: DefaultProfile(),
	})
	...
	mu.Unlock()
	if len(got) != 1 || got[0] != "192.0.2.162:5555" {
...
func TestGui52Fix4ProbeNoActiveNoop(t *testing.T) {
	...
	gui15Seed(a.profiles, "Xiaomi Pad 8 Pro", &DeviceEntry{
		Marketname: "Xiaomi Pad 8 Pro",
		Serials:    []string{"TEST0002"},
		Addrs:      []AddrEntry{{Addr: "192.0.2.162:44125", State: AddrStateStale, Mode: ModeTls}},
		Profiles:   DefaultProfile(),
	})
	calls := 0
	a.disc.ConnectOutFn = func(ctx context.Context, addr string) (string, error) {
