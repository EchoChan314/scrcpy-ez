...
// seedGui24TabletArchive 播种平板档案（现场基线）：serial TEST0002、
...
func TestMdnsEventsSyncTlsToArchive(t *testing.T) {
	...
	tls37201 := gui24FindAddr(e, "192.0.2.183:37201")
	if tls37201 == nil {
	...
	tcpip162 := gui24FindAddr(e, "192.0.2.162:5555")
...
func TestMdnsEventsIdempotent(t *testing.T) {
	...
	second37201 := gui24FindAddr(second, "192.0.2.183:37201")
	if second37201 == nil {
	...
	if gui24FindAddr(second, "192.0.2.183:5555") != nil {
		t.Fatalf("旧地址 183:5555 应按单记忆删除: %+v", second.Addrs)
	}
	if second.Wireless != ModeTls || second.TlsGuid != "adb-TEST0002-On9v2R" {
